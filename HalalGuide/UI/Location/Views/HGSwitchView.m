...
- (void)setupViews {
    ...
    self.halalLabel.text = NSLocalizedString(@"HGSwitchView.label.halal", nil);
    ...
    self.halalSwitch.onLabel.text = NSLocalizedString(@"HGSwitchView.switch.on", nil);
    self.halalSwitch.offLabel.text = NSLocalizedString(@"HGSwitchView.switch.off", nil);
    ...
    self.alcoholLabel.text = NSLocalizedString(@"HGSwitchView.label.alcohol", nil);
    ...
    self.alcoholSwitch.onLabel.text = NSLocalizedString(@"HGSwitchView.switch.on", nil);
    self.alcoholSwitch.offLabel.text = NSLocalizedString(@"HGSwitchView.switch.off", nil);
    ...
    self.porkLabel.text = NSLocalizedString(@"HGSwitchView.label.pork", nil);
    ...
    self.porkSwitch.onLabel.text = NSLocalizedString(@"HGSwitchView.switch.on", nil);
    self.porkSwitch.offLabel.text = NSLocalizedString(@"HGSwitchView.switch.off", nil);
